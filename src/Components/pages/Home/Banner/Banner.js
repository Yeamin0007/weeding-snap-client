...
const Banner = () => {
    return (
        <div>
            <div className="hero min-h-screen" style={{ backgroundImage: `url("https://nitinaroraphotography.com/wp-content/uploads/2022/03/indian-1.jpg")` }}>
...
ON THE WEDDING DAY,<br/> IGNORE ME, ENJOY YOUR WEDDING DAY <br/>& LET US CAPTURE YOUR DAY <br/> AS IT HAPPENS WITHOUT ANY FUSS. 
            </div>